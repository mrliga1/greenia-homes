/* ==============================================================
   UI.JS - BỘ NÃO ĐIỀU KHIỂN GIAO DIỆN (FINAL & BULLETPROOF)
============================================================== */

// --------------------------------------------------------------
// PHẦN 1: CÁC HÀM LẮP RÁP HỆ THỐNG (LẤY TỪ KHO)
// --------------------------------------------------------------
...
async function loadSpecificMenu(containerId, menuId) {
    try {
        const response = await fetch('components/sub-menus.html');
...
// --------------------------------------------------------------
// PHẦN 2: CÁC HÀM HIỆU ỨNG GIAO DIỆN
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// PHẦN 3: HỆ THỐNG FORM, POPUP & TRACKING
// --------------------------------------------------------------
function initMasterFormsAndPopup() {
    ...
    // 3. XỬ LÝ SUBMIT CHUNG BẰNG ỦY QUYỀN SỰ KIỆN (Bắt cả Form Vạn Năng lẫn Form Popup)
    document.addEventListener('submit', function(e) {
        
        // TRƯỜNG HỢP 1: BẮT ĐÚNG CÁI FORM POPUP NGUYÊN BẢN CỦA BẠN
        ...
        // TRƯỜNG HỢP 2: CÁC FORM VẠN NĂNG KHÁC BẰNG CLASS (Ví dụ Form Footer)
    ...
    // Click ra ngoài viền đen để đóng Popup
...
// --------------------------------------------------------------
// PHẦN 4: ĐIỂM KHỞI ĐỘNG (IGNITION SWITCH)
// --------------------------------------------------------------
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Khởi động toàn bộ Hệ thống Form, Popup và Tracking
